...
#  os: [ Linux, armv7l, esp32, Darwin, mingw64 ] # An optional list of targeted operating-systems.
  dependencies: [ idnai-make ] # The packages required to run this one, if not present 'idnai-make' is added.
}
endef
...
define notepad
  - Something to do.
  - A idea noted here to avoid forgetting it. 
endef
